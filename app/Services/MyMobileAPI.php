...
class MyMobileAPI
{
	public function __construct()
	{
		...
		$this->username = 'dblumenau'; //your login username
		$this->password = 'Gogekian5'; //your login password
	}
	...
	private function querySmsServer($data, $optional_headers = null)
	{
		...
		if (!$response) return NULL; else return new SimpleXMLElement($response);
	}
